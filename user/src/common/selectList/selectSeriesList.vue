<template>
  <div id="select-series-list" @mouseover="showList" @mouseout="hideList">
    <div 
        class="select-list-value" 
        :class="{'borderLight': borderLight}"
        ref="valueDiv">
        <span class="select-value" :class="{dark: !selectItemData.seriesName}">
            {{ selectItemData.seriesName ? selectItemData.seriesName : title }}
        </span>
