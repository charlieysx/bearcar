<template>
  <div id="select-province-list" @mouseover="showList" @mouseout="hideList">
    <div 
        class="select-list-value" 
        :class="{'borderLight': borderLight}"
        ref="valueDiv">
        <span class="select-value" :class="{dark: !selectItemData.provinceName}">
            {{ selectItemData.provinceName ? selectItemData.provinceName : title }}
        </span>
...
export default {
  name: 'selectProvinceList',
  props: ['selectModel', 'mark', 'title', 'currentProvince'],
  data () {
    return {
      borderLight: false,
      width: '0px',
