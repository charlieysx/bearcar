<template>
  <div id="select-district-list" @mouseover="showList" @mouseout="hideList">
    <div 
        class="select-list-value" 
        :class="{'borderLight': borderLight}"
        ref="valueDiv">
        <span class="select-value" :class="{dark: !selectItemData.districtName}">
            {{ selectItemData.districtName ? selectItemData.districtName : title }}
        </span>
...
export default {
  name: 'selectDistrictList',
  props: ['selectModel', 'mark', 'title'],
  data () {
    return {
      borderLight: false,
      width: '0px',
