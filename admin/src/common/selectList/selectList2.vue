<template>
  <div id="select-list2" @mouseover="showList" @mouseout="hideList">
    <div 
        class="select-list-value" 
        :class="{'borderLight': borderLight}"
        ref="valueDiv">
        <span class="select-value" :class="{dark: !selectItemData.value}">
            {{ selectItemData.value ? selectItemData.value : title }}
        </span>
